...
SECRET_KEY = 'django-insecure-l7(lu^(5z-mp*d+3iw_&(%ept59ag&p&((g^gc=-^aq1zmm23b'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'AdrianoMG.pythonanywhere.com']
...
ON_PYTHONANYWHERE = 'pythonanywhere' in sys.executable
